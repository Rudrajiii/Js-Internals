...
module.exports = {
  __splice: Array.prototype.__splice,
  splice_internals: function () {
    const outputDir = path.join(process.cwd(), "custom-js-functions");
    const outputPath = path.join(outputDir, "custom_splice.js");
...
`;
      const code =
        "Array.prototype.__splice = " + Array.prototype.__splice.toString();
